						...
						<ul>
					        <li>
								...
								<form method="post" action="shopping.php?action=add&id=<?php echo $row_img["id_produk"]; ?>">  
									...
									<!-- <a href="detail-product.php"><img src="<?php echo $row_img["gambar"]; ?>" class="img-responsive" /></a><br />   -->
								...
								<!-- <a href="#">
										<img src="<?php echo $row_img['gambar']; ?>" >
									</a>
									<a href="#">
										<h4><?php echo $row_img['tipe_iphone']; ?> <?php echo $row_img['tahun']; ?></h4>
									</a>
									<p class="price">Rp <?php echo $row_img['harga']; ?></p>
									<div >
