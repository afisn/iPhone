		...
		<div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav nav-main">
					...
					<li class="active"><a href=#>Rate</a></li>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="single-product-img">
                        <form id="rate" novalidate action="rate-page.php"  method="post">
                       
                        <!-- form data diri -->
                        <fieldset>
                            <h4>1. Lengkapi Data Diri</h4>
                            ...
                            <div class="form-group">
                            <label for="alamat">Gender</label><br>
                            <label class="radio-inline"><input type="radio" name="optradioL">Male</label>
                            <label class="radio-inline"><input type="radio" name="optradioP">Female</label>
                            </div>                            
                            <div class="form-group">
                            <label for="umur">Age</label>
                            <input type="text" class="form-control" id="umur" placeholder="Age">
                            </div>
                        ...
                        <!-- Form pertanyaan -->
                        <fieldset>
                            <h4>2. Apa tipe iPhone yang paling menarik?</h4>
                            <div class="form-group">
                            <label for="tipelist">Tipe iPhone</label>
                            <label for="isi"></label>
                            
                                <select class="form-control" id="tipe_iphone" name="tipe">
                                <?php
                                    include 'koneksi.php';
                                    $getTipe=mysqli_query($con, "SELECT tipe_iphone FROM tb_produk ORDER BY tahun asc") or die("Could not retrieve image: " .mysqli_error($conn));  
                                    while($row =mysqli_fetch_assoc($getTipe)) {
                                ?>
                                  <option value="<?php echo $row['tipe_iphone']; ?>"><?php echo $row['tipe_iphone']; ?></option>
                                <?php 
                                } 
                                ?>
                                </select>    
