							...
							<fieldset>
								...
								<div class="form_content clearfix">
									...
									<label for="email">E-mail address</label>
										<span><input placeholder="E-mail address" type="text" id="email" name="email" value="" class="account_input" required></span>
									</p>
									<p class="text">
...
<!-- breadcrumb Start
	...
	<?php
		...
		$item_id =  $_GET["id"];
		include 'koneksi.php';
		$getImage=mysqli_query($con, "SELECT * FROM tb_produk WHERE id_produk=$item_id") or die("Could not retrieve image: " .mysqli_error($conn));
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							...
							<a class="view-link" href="products.php">Back</a>
